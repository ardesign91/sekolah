...
<div class="col-lg-12 col-md-12 col-sm-12 ">
	...
	<div class="card">
		<div class="card-header bg-success">
			<h6 class="text-center text-white">Registrasi <?=__session('_student')?></h6>
		</div>
		<div class="card-body shadow"> 
			<form>
				...
				<div class="offset-sm-4 col-sm-8">
					<button type="button" onclick="student_registration(); return false;" class="btn btn-success pull-right"><i class="bx bx-send"></i> Simpan Formulir Pendaftaran</button>
				</div>
			</div>
			</form>
		</div>
